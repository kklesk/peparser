...
pub enum PEConstantCharacteristics{
...
pub enum PEConstantCharacteristicsDLL{
...
pub enum PEConstantSectionFlags{
    /* Reserved for future use. 
    ...
    */
    ...
    IMAGE_SCN_CNT_UNINITIALIZED_ DATA=0x00000080,
...
pub enum PEConstantWindowsSubsystem{
...
pub enum PEConstantSectionData{
